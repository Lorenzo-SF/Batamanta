%{
  configs: [
    %{
      ...
      checks: %{
        extra: [
          {Credo.Check.Design.AliasUsage, if_called_more_than: 2, if_nested_deeper_than: 2},
        ...
        disabled: [
          ...
          #
          # Please read the `config/default.exs` in Credo's repository for more information
          # on why these checks are disabled by default.
          #
